...
n = input('Digite algo: ')
print('É numerico?', n.isnumeric())               # o bloco 'is' é um métodos muito útil para validação de entrada de dados, onde você precisa garantir as informações fornecidas
